...
public class QuestRender {
    ...
    public QuestRender(Quest quest, GuiGraphics guiGraphics, int scissorX, int scissorY, int scissorWidth, int scissorHeight, int screenCenterX, int screenCenterY, int textureX, int textureY) {
        ...
        this.renderQuestType(guiGraphics, quest, positionX, positionY, scissorX, scissorY, scissorWidth, scissorHeight);
        this.renderIcon(quest, positionX, positionY, scissorX, scissorY, scissorWidth, scissorHeight, guiGraphics);
    }
    ...
    private void renderQuestType(GuiGraphics guiGraphics, Quest quest, int positionX, int positionY, int scissorX, int scissorY, int scissorWidth, int scissorHeight) {
        ...
        if (quest.isActive()) {
            guiGraphics.blit(QUEST_TYPE_TEXTURE, positionX - 2, positionY - 1, 0, 32, 22, 22, 86, 54);
        } else {
            guiGraphics.blit(QUEST_TYPE_TEXTURE, positionX - 2, positionY - 1, 0, 0, 22, 22, 86, 54);
        }
